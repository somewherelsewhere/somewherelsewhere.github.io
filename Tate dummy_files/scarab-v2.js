var _scq = _scq || [];
_scq.push(['setMerchantId', '15F8C397B23FCB36']);
...
var ScarabUtil = function() {
  ...
  var createStorageFactory = function createStorageFactory(noTopDomain, w, errorHandler, debugHandler) {
...
;var ScarabModule = function(win, config) {
  ...
  var storageFactory = ScarabUtil.createStorageFactory(noTopDomain, w, publicInterface.errorMessage, debugMessage);
  var init = function() {
